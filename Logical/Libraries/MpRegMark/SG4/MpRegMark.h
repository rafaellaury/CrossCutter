...
#define _MpRegMark_VERSION 5.24.2
#endif
...
typedef enum MpRegMarkControlBufferTypeEnum
{	mpREGMARK_BUFFER_NOT_USED = 0,
	mpREGMARK_BUFFER_AUTOMATIC = 1,
	mpREGMARK_BUFFER_USER_DEFINED = 2
} MpRegMarkControlBufferTypeEnum;

typedef enum MpRegMarkControlFilterTypeEnum
{	mpREGMARK_FILTER_NOT_USED = 0,
	mpREGMARK_FILTER_MOVING_AVERAGE = 1
} MpRegMarkControlFilterTypeEnum;

typedef enum MpRegMarkControlTypeEnum
{	mpREGMARK_CONTROL_POSITION_ERROR = 0,
	mpREGMARK_CONTROL_PRODUCT_LENGTH = 1
...
typedef struct MpRegMarkControlBufferType
{	enum MpRegMarkControlBufferTypeEnum Type;
	unsigned short NumberOfProducts;
	double DistanceSensorToProcess;
} MpRegMarkControlBufferType;

typedef struct MpRegMarkControlFilterType
{	enum MpRegMarkControlFilterTypeEnum Type;
	unsigned short NumberOfProducts;
} MpRegMarkControlFilterType;

typedef struct MpRegMarkControlLimiterType
{	plcbit Enable;
	double MaximumValue;
} MpRegMarkControlLimiterType;

typedef struct MpRegMarkControlType
{	enum MpRegMarkControlTypeEnum Type;
	struct MpRegMarkControlBufferType Buffer;
	struct MpRegMarkControlFilterType Filter;
	struct MpRegMarkControlLimiterType Limiter;
} MpRegMarkControlType;
...
{	struct MpRegMarkSensorSignalType SensorSignal;
	...
	struct MpRegMarkControlType Control;
